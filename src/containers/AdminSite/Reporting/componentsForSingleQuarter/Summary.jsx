...
class Summary extends PureComponent {
  render() {
    const {
      auditStartDate, findings, recommendations, months, organization,
    } = this.props;
    return (
      <div className="summary-page">
        <div className="summary-content">
          ...
          <div className="summary-box">
            ...
            <p style={{ fontSize: '14px', textAlign: 'justify' }}>To collect an appropriate sample of waste for the audit, segregated waste were collected from the bins at designated areas of {organization} for several months, which were predetermined and will serve to analyze the total amount of waste, the employees&apos; behavior, and improve {organization}&apos;s best practices for waste management.</p>
          </div>
          <div className="summary-box">
