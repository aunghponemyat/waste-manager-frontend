        ...
        <div className="intro-content">
          ...
          <div className="div-2">
            ...
            <div style={{ marginTop: 20 }}>
              ...
              Dear Sir(s), <br /><br />
              We enclose a report of our interim findings (the “Interim Report”) for the period from {formatDate(new Date(minMonth))} to {formatDate(new Date(maxMonth))} in accordance our engagement agreement dated {contractDate.toDateString()} (the “Engagement Agreement”), for waste management service. <br /><br />
